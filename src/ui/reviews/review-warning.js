...
function ReviewWarning({ onClose, type }) {
   if (type === 'review')
      return (
         <div className="flex flex-col gap-8 2xl:gap-6 px-14 py-10 2xl:py-8 rounded-lg bg-primary-0 md:px-12">
            ...
            <button
               onClick={onClose}
               className="px-6 2xl:px-5 py-2 2xl:py-1.5 rounded-md border-2 text-2xl 2xl:text-xl md:text-2xl xs:text-xl border-secondary border-primary-400 hover:bg-primary-100 transition-text w-fit self-center"
            >
               Close
            </button>
         </div>
